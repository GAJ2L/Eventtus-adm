...
class EventoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $row1 = $this->form->addFields([new TLabel('Código', null, '14px', null, '100%'),$id],[new TLabel('Responsável', null, '14px', null, '100%'),$responsavel_id]);
        ...
        $column_contato_nome = new TDataGridColumn('contato_nome', 'Contato', 'left');
        ...
        $container->add(TBreadCrumb::create(['Cadastros','Eventos']));
