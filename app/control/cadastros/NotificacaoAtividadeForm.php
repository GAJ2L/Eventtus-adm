...
class NotificacaoAtividadeForm extends TPage
{
    protected $form;
    private $formFields = [];
    ...
    private static $formName = 'form_NotificacaoAtividade';
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle('Cadastro de notificação atividade');
        ...
        $container->add(TBreadCrumb::create(['Geral','Cadastro de notificação atividade']));
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            **/
            ...
            $object = new NotificacaoAtividade(); // create an empty object 
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new NotificacaoAtividade($key); // instantiates the Active Record 
