...
class PerguntaList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $row1 = $this->form->addFields([new TLabel('Atividade', null, '14px', null, '100%'),$atividade_id],[new TLabel('Descrição', null, '14px', null, '100%'),$descricao]);
        ...
        $container->add(TBreadCrumb::create(['Cadastros','Perguntas']));
