...
class InscricaoList extends TPage
{
    ...
    private static $formName = 'formList_Inscricao';
    ...
    public function __construct()
    {
        ...
        $row1 = $this->form->addFields([new TLabel('Código', null, '14px', null, '100%'),$id],[new TLabel('Pessoa', null, '14px', null, '100%'),$pessoa_id]);
        $row1->layout = [' col-sm-3',' col-sm-9'];

        $row2 = $this->form->addFields([new TLabel('Evento', null, '14px', null, '100%'),$evento_id]);
        ...
        $btn_onshow = $this->form->addAction('Cadastrar', new TAction(['InscricaoForm', 'onShow']), 'fa:plus #69aa46');
        ...
        $action_onDelete = new TDataGridAction(array('InscricaoList', 'onDelete'));
        ...
        $container->add(TBreadCrumb::create(['Geral','Inscrições']));
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                // instantiates object
                $object = new Inscricao($key, FALSE); 
