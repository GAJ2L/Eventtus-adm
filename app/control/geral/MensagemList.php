...
class MensagemList extends TPage
{
    private $form; // form
    ...
    private static $formName = 'formList_Mensagem';
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('Listagem de mensagems');
        ...
        $row1 = $this->form->addFields([new TLabel('Id:', null, '14px', null, '100%'),$id],[new TLabel('Inscricao atividade id:', null, '14px', null, '100%'),$inscricao_atividade_id]);
        $row1->layout = ['col-sm-6','col-sm-6'];

        $row2 = $this->form->addFields([new TLabel('Dt registro:', null, '14px', null, '100%'),$dt_registro],[new TLabel('Conteudo:', null, '14px', null, '100%'),$conteudo]);
        ...
        $btn_onshow = $this->form->addAction('Cadastrar', new TAction(['MensagemForm', 'onShow']), 'fa:plus #69aa46');
        ...
        $column_inscricao_atividade_id = new TDataGridColumn('inscricao_atividade_id', 'Inscricao atividade id', 'left');
        ...
        $this->datagrid->addColumn($column_inscricao_atividade_id);
        $this->datagrid->addColumn($column_dt_registro);
        $this->datagrid->addColumn($column_conteudo);

        $action_onEdit = new TDataGridAction(array('MensagemForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('MensagemList', 'onDelete'));
        ...
        $container->add(TBreadCrumb::create(['Geral','Mensagems']));
    ...
    public function onSearch()
    {
        ...
        if (isset($data->inscricao_atividade_id) AND ( (is_scalar($data->inscricao_atividade_id) AND $data->inscricao_atividade_id !== '') OR (is_array($data->inscricao_atividade_id) AND (!empty($data->inscricao_atividade_id)) )) )
        {

            $filters[] = new TFilter('inscricao_atividade_id', '=', $data->inscricao_atividade_id);// create the filter 
        }
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Mensagem
