...
class OpcaoList extends TPage
{
    ...
    private static $activeRecord = 'Opcao';
    private static $primaryKey = 'id';
    private static $formName = 'formList_Opcao';
    ...
    public function __construct()
    {
        ...
        $this->form->setFormTitle('Listagem de opcaos');
        ...
        $row2 = $this->form->addFields([new TLabel('Descricao en:', null, '14px', null, '100%'),$descricao_en],[new TLabel('Valor:', null, '14px', null, '100%'),$valor]);
        ...
        $btn_onshow = $this->form->addAction('Cadastrar', new TAction(['OpcaoForm', 'onShow']), 'fa:plus #69aa46');
        ...
        $action_onEdit = new TDataGridAction(array('OpcaoForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('OpcaoList', 'onDelete'));
        ...
        $container->add(TBreadCrumb::create(['Geral','Opcaos']));
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Opcao
